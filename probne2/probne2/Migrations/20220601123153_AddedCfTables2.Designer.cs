...
namespace probne2.Migrations
{
    ...
    [Migration("20220601123153_AddedCfTables2")]
    partial class AddedCfTables2
    {
            ...
            modelBuilder.Entity("probne2.Entities.Action", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            StartTime = new DateTime(2022, 6, 1, 14, 31, 53, 667, DateTimeKind.Local).AddTicks(4360)
                        },
                        new
                        {
                            IdAction = 2,
                            ...
                            NeedSpecialEquipment = true,
                            StartTime = new DateTime(2022, 6, 1, 14, 31, 53, 667, DateTimeKind.Local).AddTicks(4520)
                        });
                });
            ...
            modelBuilder.Entity("probne2.Entities.FireTruckAction", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            IdFiretruck = 1,
                            IdAction = 1,
                            AssignmentDate = new DateTime(2022, 6, 1, 14, 31, 53, 667, DateTimeKind.Local).AddTicks(4540)
                        },
                        new
                        {
                            IdFiretruck = 2,
